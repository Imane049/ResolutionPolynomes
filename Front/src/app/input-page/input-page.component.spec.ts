...
import { PolynomialService, PolynomialRequest } from '../services/polynomial.service';
...
export class InputPageComponent {
  ...
  showTooltip(method: string, event: MouseEvent) {
    this.tooltipText = this.analyticalMethodInfo[method] || '';
    this.tooltipPosition = { top: event.clientY + 10, left: event.clientX + 10 };
